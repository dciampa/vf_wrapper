...
ion_wave_string='CII_1334' # Must be a string formatted ion_wave
velocity_span = 600.0
rebin_factor=3
...
data_directory=home_dir+'LA/vf_data/UVQSJ101629.20-315023.6/'  # /Users/kat/HST/Smith_Cloud/reduction/UVQSJ203335.89-032038.5
#fit_directory=base_directory+'analysis/UV_Fits/' # /Users/kat/HST/Smith_Cloud/Analysis/UV_Fits
fit_directory=home_dir+'LA/vf_fits/UVQSJ101629.20-315023.6/' # /Users/kat/HST/Smith_Cloud/Analysis/UV_Fits
...
if ion_string == 'OI':
    ...
    print("You may want to use night time data!")
...
if rawdata==True:
    dataset.prepare_dataset(norm=True, mask=masking, velocity=True)
else:
    dataset.prepare_dataset(norm=False, mask=masking, velocity=True)
